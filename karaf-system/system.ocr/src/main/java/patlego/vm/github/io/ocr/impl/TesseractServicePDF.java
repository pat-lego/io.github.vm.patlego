...
@Component(immediate = true, service = OCRService.class, property = { "OCR_TYPE=PDF", "RENDERER=TESSERACT" })
public class TesseractServicePDF implements OCRService {
    ...
    private List<String> getCommands(TesseractConversionInput input) {
        ...
        command.add(OCRService.PDF.toLowerCase());
